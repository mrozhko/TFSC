...
public:
    ...
    //Obtain mining balance
    DBStatus GetTotalAwardAmount(uint64_t &Total);
    ...
    //Initialize the program version of the database
...
public:
    ...
    //Set total mining amount
    DBStatus SetTotalAwardAmount(uint64_t &MiningBalance);
    //Setting up the utxo account of encumbered assets
