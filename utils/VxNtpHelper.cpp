...
////////////////////////////////////////////////////////////////////////////////
// Defines the operation macro of the test information output interface
...
typedef struct x_ntp_packet_t
{
    ...
    x_uchar_t         xct_stratum    ;      ///< The number of layers of the system clock, the value range is 1~16, which defines the accuracy of the clock. The clock with the number of layers of 1 has the highest accuracy, the accuracy decreases from 1 to 16, and the clock with the number of layers 16 is in an unsynchronized state and cannot be used as a reference clock The number of layers of the system clock, the value range is 1~16, which defines the accuracy of the clock. The clock with layer number 1 has the highest accuracy, decreasing accuracy from 1 to 16, and the clock with layer number 16 is unsynchronized and cannot be used as a reference clock
 ...
 * @param [in ] xit_family :  type of socket address structure expected to be returned
...
/**********************************************************/
/**
 * @brief Send an NTP request to the NTP server to get the server timestamp for testing.
 * 
 * @param [in ] xszt_host :  The IP (four-segment IP address) or domain name (such as 3.cn.pool.ntp.org) of the NTP server.
 * @param [in ] xut_port  : The port number of the NTP server (whichever is the default port number NTP_PORT : 123).
