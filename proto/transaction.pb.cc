...
const uint32_t TableStruct_transaction_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::CTransaction, _impl_.gas_),
  PROTOBUF_FIELD_OFFSET(::CTransaction, _impl_.cost_),
...
const char descriptor_table_protodef_transaction_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\031\n\tmultiSign\030\004 \003(\0132\006.CSign\"\230\002\n\014CTransact"
  ...
  "onsensus\030\010 \001(\r\022\013\n\003gas\030\t \001(\004\022\014\n\004cost\030\n \001("
  "\004\022\016\n\006txType\030\013 \001(\r\022\014\n\004data\030\014 \001(\t\022\014\n\004info\030"
  "\r \001(\t\022\032\n\nverifySign\030\016 \003(\0132\006.CSign\022\020\n\010res"
  "erve0\030\017 \001(\t\022\020\n\010reserve1\030\020 \001(\tb\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_transaction_2eproto = {
    false, false, 597, descriptor_table_protodef_transaction_2eproto,
    "transaction.proto",
...
CTransaction::CTransaction(const CTransaction& from)
  ...
  ::memcpy(&_impl_.time_, &from._impl_.time_,
    ...
    reinterpret_cast<char*>(&_impl_.time_)) + sizeof(_impl_.cost_));
...
uint8_t* CTransaction::_InternalSerialize(
  ...
  if (this->_internal_gas() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(9, this->_internal_gas(), target);
  }

  // uint64 cost = 10;
  if (this->_internal_cost() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(10, this->_internal_cost(), target);
  }

  // uint32 txType = 11;
  if (this->_internal_txtype() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(11, this->_internal_txtype(), target);
  }
  ...
  if (!this->_internal_reserve0().empty()) {
    ...
    target = stream->WriteStringMaybeAliased(
        15, this->_internal_reserve0(), target);
  }
  ...
  if (!this->_internal_reserve1().empty()) {
    ...
    target = stream->WriteStringMaybeAliased(
        16, this->_internal_reserve1(), target);
  }
...
void CTransaction::InternalSwap(CTransaction* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(CTransaction, _impl_.cost_)
      + sizeof(CTransaction::_impl_.cost_)
      - PROTOBUF_FIELD_OFFSET(CTransaction, _impl_.utxo_)>(
