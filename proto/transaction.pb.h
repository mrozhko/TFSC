...
class CTransaction final :
 ...
 public:
  ...
  enum : int {
    kVerifySignFieldNumber = 14,
    kIdentityFieldNumber = 4,
    kHashFieldNumber = 5,
    kTypeFieldNumber = 7,
    kDataFieldNumber = 12,
    kInfoFieldNumber = 13,
    kReserve0FieldNumber = 15,
    kReserve1FieldNumber = 16,
    kUtxoFieldNumber = 6,
    kTimeFieldNumber = 2,
...
// uint64 gas = 9;
inline void CTransaction::clear_gas() {
  _impl_.gas_ = uint64_t{0u};
}
inline uint64_t CTransaction::_internal_gas() const {
  return _impl_.gas_;
}
inline uint64_t CTransaction::gas() const {
  // @@protoc_insertion_point(field_get:CTransaction.gas)
  return _internal_gas();
}
inline void CTransaction::_internal_set_gas(uint64_t value) {
  
  _impl_.gas_ = value;
}
inline void CTransaction::set_gas(uint64_t value) {
  _internal_set_gas(value);
  // @@protoc_insertion_point(field_set:CTransaction.gas)
}

// uint64 cost = 10;
inline void CTransaction::clear_cost() {
  _impl_.cost_ = uint64_t{0u};
}
inline uint64_t CTransaction::_internal_cost() const {
  return _impl_.cost_;
}
inline uint64_t CTransaction::cost() const {
  // @@protoc_insertion_point(field_get:CTransaction.cost)
  return _internal_cost();
}
inline void CTransaction::_internal_set_cost(uint64_t value) {
  
  _impl_.cost_ = value;
}
inline void CTransaction::set_cost(uint64_t value) {
  _internal_set_cost(value);
  // @@protoc_insertion_point(field_set:CTransaction.cost)
}
